...
| 標的 | 追蹤問題 | 現況（隨每期更新） |
|---|---|---|
| **ENISA Single Reporting Platform（SRP）** | "The Cyber Resilience Act (CRA) introduces the Single Reporting Platform (SRP) for cybersecurity incident reporting in the EU Digital Single Market." —— **何時正式完工、啟用？** 官方規劃與 9/11 通報義務同步上線，須每期確認：平台是否已上線、公開網址是否公布、國家 CSIRT 協調員名單是否公布、是否提供通報 API、ENISA 指引／onboarding 文件更新、上線後的實際運作狀況與問題 | 截至 2026-08-30 仍未上線；公開網址與 CSIRT 協調員名單皆未公布，且確認**現階段不提供 API**；ENISA 規劃上線前約兩週辦說明會 |
| **CRA 調和標準刊登歐盟公報（OJ）** | **第一個 CRA 調和標準（harmonised standard）何時刊登 OJ？** 刊登之日起 Article 27 合規推定（presumption of conformity）才開始可用。須每期確認：OJ 是否已刊登任何 CRA 調和標準（刊登哪些、對應哪些產品類別）、CEN／CENELEC／ETSI 各標準草案進度（公眾意見徵詢、核准、交付執委會）、漏洞處理 Type A 標準與通用要求標準的時程變化 | 截至 2026-08-30 OJ 尚無任何 CRA 調和標準；ETSI 已於 2026-08-13 將 17 項產品類別標準（EN 304 617–627、631–636）送進公眾意見徵詢，程序依垂直類別跑到 2026-09 中～11 月中 |
| **CRA 標準化委託 M/606 交付期限延後兩個月** | 執委會於 2026-07 公布 M/606 修訂草案，把 2026 年的標準交付期限整體往後推兩個月：橫向 A 類與漏洞管理 B 類由 2026-08-30 移至 **2026-10-31**、產品專屬 C 類由 2026-10-30 移至 **2026-12-31**——**修訂案是否正式通過？新期限是否再度跳票？** 法規本身的義務與適用日（2026-09-11 通報、2027-12-11 主要義務）一天都沒有改變，往後推的只有標準，因此延後直接壓縮「刊登 OJ 到義務日」之間的緩衝。須每期確認：修訂案的正式通過狀態與刊登情形、A/B 類與 C 類是否如期交付、是否出現第二次延後、交付後執委會評估與刊登 OJ 的進度 | 截至 2026-08-30 仍為草案階段；原訂的 A/B 類期限 2026-08-30 已屆期而未交付 |
| **CMMC 改革小組報告（9 月中出爐）** | DoD 的 60 天 CMMC 改革小組報告**何時發布、結論為何？** 報告將決定 Phase 2 第三方認證的存廢與替代方案（自我聲明擴大、商用方案採認、時程重排），直接影響國防供應鏈的合規路線。須每期確認：報告是否發布、發布後的關鍵結論（C3PAO 認證恢復或取代、Level 2/3 要求變化）、DoD 是否啟動 DFARS／32 CFR 修訂、Phase 2 暫停狀態是否變化 | RFI 已於 2026-08-14 截止；報告預計 2026-09-13 前後送交 DoW CIO（部分分析認為公開時間可能落在 9 月中至 10 月初）；Phase 2 維持暫停，Phase 1 自評、SPRS 與 DFARS 252.204-7012 義務不變 |
| **NIS2 四國訴訟案（CJEU）結果** | 執委會於 2026-07-08 以未完成 NIS2 轉換為由，將**愛爾蘭、西班牙、法國、荷蘭**移送歐洲法院（CJEU），請求課以一次性罰款與按日計罰——**判決結果與罰款金額為何？** 須每期確認：CJEU 程序進度（案號、言詞辯論、佐審官意見、判決）、執委會是否因成員國完成轉換而撤回個別案件（荷蘭已於 2026-08-15 生效轉換法，其被訴基礎可能消失）、其餘三國的轉換立法進度 | 截至 2026-08-30 CJEU 無公開程序進展；荷蘭 8/15 生效且登記已轉為強制，惟執委會尚未公告撤案；愛爾蘭稱 2026 年底前完成、西班牙法案未刊 BOE、法國無明確時程 |
| **EU AI Act 調和標準進度** | **第一個 AI Act 調和標準（harmonised standard）何時刊登 OJ？** 高風險 AI 系統義務已延至 2027-12-02，調和標準須在此之前到位，刊登之日起高風險系統才有合規推定可用。須每期確認：CEN-CENELEC JTC 21 各標準草案進度（起草、公眾意見徵詢、核准、交付執委會）、OJ 是否刊登、執委會標準化委託的時程調整、ISO 42001 等國際標準是否被採認為調和標準 | 截至 2026-08-30 OJ 尚無任何 AI Act 調和標準；EN 18286（Article 17 QMS）已於 2026-07-12 核准發布但待刊登；prEN 18228（風險管理）意見徵詢 2026-07-30 結束；ISO 42001 非調和標準（認證不構成合規推定） |

- 報導位置：SRP、CRA 調和標準與 M/606 期限延後在 `eu-cra`、AI Act 調和標準在 `eu-ai-act`、CMMC 改革報告在 `cmmc`、NIS2 訴訟案在 `nis2`；**里程碑達成當期（SRP 正式啟用／CRA 或 AI Act 首個調和標準刊登 OJ／M/606 修訂正式通過或新期限跳票／CMMC 改革報告發布／CJEU 判決或撤案）以 high 回報**，之後轉為後續追蹤
...
- M/606 期限延後查詢角度：執委會標準化委託頁與 comitology／Have Your Say 上的修訂草案文件、CEN-CENELEC 與 ETSI 的工作計畫與交付公告、cyberresilienceact.eu 與 ibf-solutions.com 的標準化進度追蹤；**撰稿時務必區分三個里程碑：交付執委會 ≠ 核准為 EN ≠ 刊登 OJ**，並在每期重申法規適用日未隨之變動
