...
| **ISO 27000 系列** | **不限 27001，須逐一涵蓋系列中與資訊安全相關的標準**：27000（總覽/術語）、27001（ISMS 要求）、27002（控制措施）、27003（實施指引）、27004（量測）、27005（風險管理）、27006（驗證機構要求）、27017/27018（雲端安全與隱私）、27019（能源產業）、27031（營運持續）、27035（事件管理）、27036（供應鏈）、27040（儲存安全）、27701（隱私資訊管理）等的改版與修訂（amendment）；另含認證機構與認可體系變動、稽核實務趨勢。<br>**延伸範圍**：與上述標準直接相關的其他資訊安全標準（如 IEC 62443 之於 OT/CRA、NIST CSF 與 SP 800-171 之於 CMMC/TISAX 對應、ISO 22301 之於營運持續），在與本站追蹤主題有實質關聯時一併納入 |
