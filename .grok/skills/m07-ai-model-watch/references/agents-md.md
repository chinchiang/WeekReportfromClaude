---
description: "Canonical AGENTS.md body to write into chinchiang/WeekReportfromClaude for Module 07. Merge if a root AGENTS.md already exists; do not wipe unrelated rules."
connections: [report-structure, snapshot-schema]
---

# 寫入 repo 的 AGENTS.md

複製以下全文到目標 repo 根目錄 `AGENTS.md`。若已存在，將「Module 07 特定規則」整節合併進去，保留其他模組規則。
